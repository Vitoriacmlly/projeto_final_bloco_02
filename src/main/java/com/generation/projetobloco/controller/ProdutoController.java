package com.generation.projetobloco.controller;
...
import com.generation.projetobloco.repository.CategoriaRepository;
import com.generation.projetobloco.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<Produto> post(@Valid @RequestBody Produto produto) {
		...
		throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Não existe!", null);
	}
